...
public static class PackGroupingDefaults
{
    ...
    public static readonly string[] BootBundles =
    {
        ...
        "ui/view_prefab",
        // HybridCLR：热更 DLL + 常用 AOT 补充元数据，随 Boot Pack 首启拉取
        "hybridclr/hotupdate/carrotfantasy.hotupdate.dll.bytes",
        "hybridclr/aot/mscorlib.dll.bytes",
        "hybridclr/aot/system.dll.bytes",
        "hybridclr/aot/system.core.dll.bytes",
        "hybridclr/aot/unityengine.coremodule.dll.bytes",
    };
