...
public class AssetBundleDownloader
{
        ...
        System.Action<bool> completeCallback)
    {
        ...
        {
            // HybridCLR 的 .dll.bytes 是原始文件，禁止走 AB Recompress。
            bool convertThis = isNeedConvert && !CarrotFantasy.HybridCLRPaths.IsHybridClrRawFile(bundleName);
            DownloadBundle(bundleName, convertThis, (success, message) =>
            {
