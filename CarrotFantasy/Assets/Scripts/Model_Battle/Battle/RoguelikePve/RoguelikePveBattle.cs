...
{
    /// <summary>
    /// 肉鸽模式 PVE 战斗框架，组件组合与 <see cref="SurvivalPveBattle"/> 对齐，便于后续独立演进。
    /// </summary>
    public class RoguelikePveBattle : BaseBattle
    {
        public RoguelikePveBattle() : base()
        {
        }
        ...
        public override void Init()
        {
            ...
            this.AddComponent(new BattleRoguelikeRunBridgeComponent(this));
            this.AddComponent(new BattleSimpleHitTestComponent(this));
            this.AddComponent(new BattlePVEMapComponent(this));
            ...
            this.AddComponent(new BattleSurvivalPVEMonsterComponent(this));
        ...
        public override void InitComponent()
        {
            ...
            this.GetComponent(BattleComponentType.RoguelikeRunBridgeComponent).Init();
